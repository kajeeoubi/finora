        ...
        <div className="divide-y divide-black/[0.06] dark:divide-white/[0.08] text-xs">
          ...
          <div className="flex items-center justify-between py-3.5">
            <div>
              ...
              <span className="text-zinc-500 dark:text-zinc-400">
                Cadangkan atau pulihkan data Excel
              </span>
            </div>
            <button
              type="button"
          ...
          <div className="flex items-center justify-between py-3.5">
            <div>
              ...
              <span className="text-zinc-500 dark:text-zinc-400">
                Hapus seluruh dompet, transaksi, dan data keuangan
              </span>
            </div>
            ...
            <Dialog open={isResetDialogOpen} onOpenChange={setIsResetDialogOpen}>
              <DialogTrigger asChild>
                <button
                  type="button"
                  className="flex items-center gap-1.5 px-4 py-2.5 rounded-2xl border border-red-200 dark:border-red-950 bg-red-50/80 hover:bg-red-100 text-red-600 dark:bg-red-950/30 dark:text-red-400 dark:hover:bg-red-950/60 font-bold text-xs active:scale-95 transition-all cursor-pointer"
                >
