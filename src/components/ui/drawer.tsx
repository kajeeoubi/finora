...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-black/40 dark:bg-black/60 transition-opacity",
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    >
      ...
      <div className="mx-auto mt-3 h-1.5 w-12 rounded-full bg-zinc-300 dark:bg-zinc-700/80 shrink-0" />
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Title
    ref={ref}
    className={cn(
      "text-lg sm:text-xl font-black text-zinc-900 dark:text-white tracking-tight",
      className
    )}
    {...props}
  />
